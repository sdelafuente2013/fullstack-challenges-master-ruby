...
def coach_answer_enhanced(your_message)
  ...
  return "I can feel your motivation! I don't care, get dressed and go to work!" if
  your_message == your_message.upcase && your_message.chars.last == "!"
  return "I can feel your motivation! Silly question, get dressed and go to work!" if
